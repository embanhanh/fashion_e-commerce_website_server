...
router.post('/login/phone', userController.loginWithFirebase)
...
router.get('/account/coins', authenticateToken, userController.getCoinsUser)
router.put('/account/coins/checkin', authenticateToken, userController.checkinCoins)
router.put('/account/coins/update-last-checkin', authenticateToken, userController.updateLastCheckin)
router.put('/account/coins/update-coins', authenticateToken, userController.updateCoinsUser)
