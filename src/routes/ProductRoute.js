...
router.get('/recommend-content-based/:product_slug', productController.recommendContentBased)
router.get('/recommend-collaborative', authenticateToken, productController.recommendCollaborative)
router.post('/recommend-hybrid', authenticateToken, productController.recommendHybrid)
router.post('/get-by-ids', productController.getProductByIds)
